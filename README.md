...
- **New Implementations**
  ...
  - [dokeysto](https://github.com/UnixJunkie/dokeysto) - key-value store for string keys and string values
  - [dokeysto_lz4](https://github.com/UnixJunkie/dokeysto) - dokeysto with on-the-fly LZ4 compression/decompression of values
  - [dokeysto_camltc](https://github.com/UnixJunkie/dokeysto) - dokeysto using tokyocabinet as backend
